	...
	if($valid == 1) {
       ...
       $orderdate = explode('-',  $split_date);
		...
		if($path=='') {
			...
			$statement = $pdo->prepare("INSERT INTO tbl_post (post_title,post_slug,post_content,post_date,photo,category_id,total_view,meta_title,meta_keyword,meta_description,post_month,post_description) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)");
			$statement->execute(array($_POST['post_title'],$post_slug,$_POST['post_content'],$_POST['post_date'],'',$_POST['category_id'],0,'',$_POST['meta_keyword'],'',$post_year_month,$_POST['post_description']));
		} else {
            ...
            $statement = $pdo->prepare("INSERT INTO tbl_post (post_title,post_slug,post_content,post_date,photo,category_id,total_view,meta_title,meta_keyword,meta_description,post_month,post_description) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)");
			$statement->execute(array($_POST['post_title'],$post_slug,$_POST['post_content'],$_POST['post_date'],$final_name,$_POST['category_id'],0,'',$_POST['meta_keyword'],'',$post_year_month,$_POST['post_description']));
		}
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								 <select class="form-control select2" name="post_month" required>
						...
						<div class="form-group">
				            <label for="" class="col-sm-2 control-label">Featured Photo (1200*800)</label>
				        ...
				        <div class="form-group">
							...
							<div class="col-sm-6">
								<textarea class="form-control" name="post_description" style="height:110px;width: 151%" required>
									<?php if(isset($_POST['post_description'])){echo $_POST['post_description'];} ?></textarea>
							</div>
						</div>
