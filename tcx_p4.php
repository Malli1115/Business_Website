<?php $page = 'product'; $pr = '4'; include'header.php'; ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="ttm_single_image-wrapper mt-35">
                                        <img class="img-fluid" src="images/product/banner3.png" title="single-img-twenty" alt="single-img-fourteen" style="width: 400px;height: 200px;">
                                    </div><!-- ttm_single_image-wrapper end -->
                                </div>
                                <div class="col-md-6">
                                    <!-- ttm_single_image-wrapper -->
                                    <div class="ttm_single_image-wrapper mt-35">
                                        <img class="img-fluid" src="images/product/banner4.png" title="single-img-twenty" alt="single-img-twenty" style="width: 400px;height: 200px;">
                                    </div><!-- ttm_single_image-wrapper end -->
                                </div>
