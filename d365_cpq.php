<?php $page = 'slu'; $ul = 'ax'; $ax = '7';  include'header.php'; ?>
                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-center">
                            <div class="page-title-heading">
                                <h1 class="title"> Configure | Price | Quote</h1>
                    ...
                    <div class="col-lg-8 content-area order-lg-2">
                        ...
                        <div class="ttm-service-single-content-area">
                            <div class="ttm_single_image-wrapper mb-35">
                                <img class="img-fluid" src="images/solutions/ax_pricing.jpg" alt="single-img-twelve">
                            </div>
                    ...
                    <div class="col-lg-4 widget-area">
                        <aside class="widget widget-nav-menu">
                            <ul class="widget-menu">
                                ...
                                <li><a href="d365_support.php">Support solutions</a></li>
                                <li class="active"><a href="d365_cpq.php">Configure | Price |Quote</a></li>
                            </ul>
                        </aside>
