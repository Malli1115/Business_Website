...
$post_month=$_GET['mth'];
$orderdate = explode('-',  $post_month);
$sfrom  = $orderdate[0];
$sto    = $orderdate[1];
$syear  = $orderdate[2];

$seprate_btw=$sfrom.' - '.$sto;

        $statement = $pdo->prepare("SELECT * FROM tbl_post WHERE post_month=?");
        $statement->execute(array($post_month));
                                  ...
                                  <div class="card-body">
                                    <div class="toggle-content">
                                        <div class="row">
                                            <div class="col-sm-12">
                                               <ul>
                                                   <?php if($post_month == 'Jan - Feb - 2021'){ ?>
                                                    ...
                                                    <?php } ?>
                                                     ...
                                                     <?php if($post_month == 'Mar - Apr - 2021'){ ?>
                                                    ...
                                                    <?php } ?>
                                                     ...
                                                     <?php if($post_month == 'May - Jun - 2021'){ ?>
                                                    ...
                                                    <?php } ?>
                                                     ...
                                                     <?php if($post_month == 'Jul - Aug - 2021'){ ?>
                                                    ...
                                                    <?php } ?>
                                                     ...
                                                     <?php if($post_month == 'Sep - Oct - 2021'){ ?>
                                                    ...
                                                    <?php } ?>
                                                     ...
                                                     <?php if($post_month == 'Nov - Dec - 2021'){ ?>
                                  ...
                                  <div class="card-body">
                                   <div class="toggle-content">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                 <ul>
                                                   <?php if($post_month == 'Jan - Feb - 2020'){ ?>
                                                      <li><a href="particular_mob.php?mth=Jan - Feb - 2020" style="color: #f36523;">Jan - Feb</a></li>
                                                    <?php }else{ ?>
                                                      <li><a href="particular_mob.php?mth=Jan - Feb - 2020">Jan - Feb</a></li>  
                                                    <?php } ?>

                                                     <?php if($post_month == 'Mar - Apr - 2020'){ ?>
                                                      <li><a href="particular_mob.php?mth=Mar - Apr - 2020" style="color: #f36523;">Mar - Apr</a></li>
                                                    <?php }else{ ?>
                                                      <li><a href="particular_mob.php?mth=Mar - Apr - 2020">Mar - Apr</a></li>  
                                                    <?php } ?>

                                                     <?php if($post_month == 'May - Jun - 2020'){ ?>
                                                      <li><a href="particular_mob.php?mth=May - Jun - 2020" style="color: #f36523;">May - Jun</a></li>
                                                    <?php }else{ ?>
                                                      <li><a href="particular_mob.php?mth=May - Jun - 2020">May - Jun</a></li>  
                                                    <?php } ?>

                                                     <?php if($post_month == 'Jul - Aug - 2020'){ ?>
                                                      <li><a href="particular_mob.php?mth=Jul - Aug - 2020" style="color: #f36523;">Jul - Aug</a></li>
                                                    <?php }else{ ?>
                                                      <li><a href="particular_mob.php?mth=Jul - Aug - 2020">Jul - Aug</a></li>  
                                                    <?php } ?>

                                                     <?php if($post_month == 'Sep - Oct - 2020'){ ?>
                                                      <li><a href="particular_mob.php?mth=Sep - Oct - 2020" style="color: #f36523;">Sep - Oct</a></li>
                                                    <?php }else{ ?>
                                                      <li><a href="particular_mob.php?mth=Sep - Oct - 2020">Sep - Oct</a></li>  
                                                    <?php } ?>

                                                     <?php if($post_month == 'Nov - Dec - 2020'){ ?>
                                                      <li><a href="particular_mob.php?mth=Nov - Dec - 2020" style="color: #f36523;">Nov - Dec</a></li>
                                                    <?php }else{ ?>
