<?php $page = 'slu'; $ul = 'ra'; include'header.php'; ?>
                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-center">
                            <div class="page-title-heading">
                                <h1 class="title"> Robotic Process Automation</h1>
                    ...
                    <div class="col-lg-8 content-area order-lg-2">
                        ...
                        <div class="ttm-service-single-content-area">
                            <div class="ttm_single_image-wrapper mb-35">
                                <img class="img-fluid" src="images/solutions/robotic_automation_process.gif" alt="single-img-twelve">
                            </div>
                    ...
                    <div class="col-lg-4 widget-area">
                        <aside class="widget widget-nav-menu">
                            <ul class="widget-menu">
                               <li ><a href="d365_crm.php">Microsoft Dynamics CRM</a></li>
                               <li class="active"><a href="robotic_automation.php">Robotic Process Automation</a></li>
                            </ul>
                        </aside>
