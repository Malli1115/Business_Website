<?php $page = 'slu'; $ul = 'crm';  include'header.php'; ?>
                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-center">
                            <div class="page-title-heading">
                                <h1 class="title"> Microsoft Dynamics CRM</h1>
                            </div><!-- /.page-title-captions -->
                            <div class="breadcrumb-wrapper">
                                <span>
                                    <a title="Homepage" href="index.php"><i class="ti ti-home"></i>&nbsp;&nbsp;Solutions</a>
                                </span>
                    ...
                    <div class="col-lg-8 content-area order-lg-2">
                        ...
                        <div class="ttm-service-single-content-area">
                            <div class="ttm_single_image-wrapper mb-35">
                                <img class="img-fluid" src="images/solutions/Customer_relationship_management.jpg" alt="single-img-twelve">
                            </div>
                    ...
                    <div class="col-lg-4 widget-area">
                        <aside class="widget widget-nav-menu">
                            <ul class="widget-menu">
                               <li class="active"><a href="d365_crm.php">Microsoft Dynamics CRM</a></li>
                               <li><a href="robotic_automation.php">Robotic Process Automation</a></li>
                            </ul>
                        </aside>
