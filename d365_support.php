<?php $page = 'slu'; $ul = 'ax'; $ax = '6';  include'header.php'; ?>
                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-center">
                            <div class="page-title-heading">
                                <h1 class="title"> Support solutions</h1>
                            </div><!-- /.page-title-captions -->
                            <div class="breadcrumb-wrapper">
                                <span>
                                    <a title="Homepage" href="index.php"><i class="ti ti-home"></i>&nbsp;&nbsp;Microsoft Dynamics AX</a>
                                </span>
                    ...
                    <div class="col-lg-8 content-area order-lg-2">
                        ...
                        <div class="ttm-service-single-content-area">
                            <div class="ttm_single_image-wrapper mb-35">
                                <img class="img-fluid" src="images/solutions/ax_supportsolution.gif" alt="single-img-twelve">
                            </div>
                            <div class="ttm-service-description">
                                ...
                                <p class="mb-35">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged</p>
                    ...
                    <div class="col-lg-4 widget-area">
                        <aside class="widget widget-nav-menu">
                            <ul class="widget-menu">
                                <li ><a href="d365_manufacturing.php">Manufacturing</a></li>
                                <li><a href="d365_distribution.php">Distribution</a></li>
                                <li><a href="d365_warehouse.php">Warehouse Management</a></li>
                                <li><a href="d365_implementations.php">Implementations</a></li>
                                <li><a href="d365_migration.php">Migration</a></li>
                                <li class="active"><a href="d365_support.php">Support solutions</a></li>
                                <li><a href="d365_cpq.php">Configure | Price |Quote</a></li>
                            </ul>
                        </aside>
                        <aside class="widget widget-download">
                            <h3 class="widget-title">Brochers</h3>
                            <ul class="download">
                                <li>
