<?php $page = 'slu'; $ul = 'ms'; $ms = '2'; include'header.php'; ?>
                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-center">
                            <div class="page-title-heading">
                                <h1 class="title"> Workflow and Approvals</h1>
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span>Workflow and Approvals</span>
                            </div>  
                        </div>
                    </div><!-- /.col-md-12 -->  
                </div><!-- /.row -->  
                    ...
                    <div class="col-lg-8 content-area order-lg-2">
                        ...
                        <div class="ttm-service-single-content-area">
                            <div class="ttm_single_image-wrapper mb-35">
                                <img class="img-fluid" src="images/solutions/websolution_workflow.jpg" alt="single-img-twelve">
                            </div>
                    ...
                    <div class="col-lg-4 widget-area">
                        <aside class="widget widget-nav-menu">
                            <ul class="widget-menu">
                                ...
                                <li ><a href="tailored.php">Tailored Micro Applications</a></li>
                                <li class="active"><a href="workflow_approvals.php">Workflow and Approvals</a></li>      
