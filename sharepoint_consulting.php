<?php $page = 'slu'; $ul = 'sp'; $sp = '2'; $ssv = '1'; include'header.php'; ?>
                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-center">
                            <div class="page-title-heading">
                                <h1 class="title"> SharePoint Consulting</h1>
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span>SharePoint Consulting</span>
                            </div>  
                        </div>
                    </div><!-- /.col-md-12 -->  
                </div><!-- /.row -->  
                    ...
                    <div class="col-lg-8 content-area order-lg-2">
                        ...
                        <div class="ttm-service-single-content-area">
                            <div class="ttm_single_image-wrapper mb-35">
                                <img class="img-fluid" src="images/solutions/sharepoint_consulatant_final.jpg" alt="single-img-twelve">
                            </div>
                    ...
                    <div class="col-lg-4 widget-area">
                        <aside class="widget widget-nav-menu">
                            <ul class="widget-menu">
                                ...
                                <li class="active"><a href="sharepoint_consulting.php">SharePoint Consulting</a></li>
                                <li><a href="sharepoint_upgrade.php">SharePoint Upgrades &#038; Migrations</a></li>
